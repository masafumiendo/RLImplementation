...
class PolicyGradientAgent(FNAgent):
    ...
    def __init__(self, actions):
        # PolicyGradientAgent uses self policy (does not use epsilon).
    ...
    def set_updater(self, optimizer):
        ...
        self._updater = K.backend.function(inputs=[self.model.input, actions, rewards], outputs=[loss], updates=updates)
...
class PolicyGradientTrainer(Trainer):
    ...
    def train(self, env, episode_count=2200, initial_count=-1, render=False):
        actions = list(range(env.action_space.n))
